...
type Report = { id: string; report_number: string; status: string; customer_company: string; customer_name: string; customer_email: string; work_date: string; employee_name: string; addition_count: number };
