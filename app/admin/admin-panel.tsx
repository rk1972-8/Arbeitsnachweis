...
export function AdminPanel({ adminName }: { adminName: string }) {
  ...
  return <main className="admin-shell">
    <header className="admin-topbar"><div className="brand-lockup"><span className="brand-mark">M</span><div><p className="brand-name">mifrro</p><p className="brand-product">Administration</p></div></div><div className="admin-nav"><a href="/admin/crm">CRM & Leads</a><Link href="/">← Zur Startseite</Link><button onClick={logout} type="button">Abmelden</button></div></header>
