...
type Report = {
  ...
  order_status?: 'draft' | 'created' | null; plenty_order_id?: string | null;
};
...
export function ReportReview({ reportId }: { reportId: string }) {
  ...
  return <main className="admin-shell"><header className="admin-topbar"><a aria-label="Zur Startseite" className="brand-lockup brand-home-link" href="/"><span className="brand-mark">M</span><div><p className="brand-name">{report.report_number}</p><p className="brand-product">Prüfung vor Kundenversand</p></div></a><div className="admin-nav"><a href="/admin">← Verwaltung</a></div></header>
